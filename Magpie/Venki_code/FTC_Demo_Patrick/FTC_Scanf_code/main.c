...
printf("Enter the bit depth,(0=16bits,1=24bits) \r\n");
scanf("%d",&bd);

printf("Enter the sample rate,(0=384k,1=192k,2=96k,3=48k,4=32k,5=24k,6=16k) \r\n");
scanf("%d",&sr);

printf("Enter the SD card slot number,(0,1,2,3,4,5) \r\n");
scanf("%d",&cs);
...
//	magpie_bitdepth = 1;
	...
	printf("Selecting SD Card Slot cs %d .....\n", cs);
	//Select Card Slot 0
	sd_card_bank_ctl_enable_slot(cs);
