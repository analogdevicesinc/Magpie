/**
 * A software module for controlling the analog gain of the AFE via a MAX14662 MUX chip is represented here. The gain
 * is set by switching resistors in the differential opamp circuit. Eight discrete gain settings are available.
 *
 * This module requires shared use of I2C0 and uses 7-bit address 0x4F
 *
...
/**
 * Available gain settings are represented here.
 *
...
/**
 * Gain control errors are represented here.
 */
typedef enum
{
    AFE_GAIN_CTL_ERR_OK,
